...
<div class="col-sm-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class=" control-label">入库产品</label>
                                    <div class=" input-group">
                                        <input type="text" class="form-control "  product_id="" id="product_name"  name="product_name"   readonly style="background: white" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" input-group">
                                        <input type="text" class="form-control "  id="staff_name" staff_id=""  name="staff_name"  readonly  style="background: white">
                                ...
                                <div class="form-group">
                                    <label class="control-label">说明方式</label>
                                    <input type="text" class="form-control "  placeholder="如：从哪里采购或退货（20字内）"  name="mode_explain" id="mode_explain" >
                                </div>
            ...
            {{--关联产品信息--}}
            <div class="modal" tabindex="-1"  id="select_product" data-backdrop="static" >
                <div class="modal-dialog">
                    <!-- 内容声明 -->
                    <div class="modal-content"  style="width: 750px;">
                        ...
                        <div class="modal-body" style="overflow: auto;max-height: 550px;" >
                            <div class="form-horizontal">
                                ...
                                <div>
                                    <ul class="pager" count="{{$product->count()}}" id="pages">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content"  style="width: 750px;">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"> <span class="glyphicon glyphicon-plus"> 选择经办人</span>  </h4>
                        </div>
                        <!-- 主体 -->
                        <div class="modal-body" style="overflow: auto;max-height: 550px;" >
                            <div class="form-horizontal">
                                ...
                                <div>
                                    <ul class="pager" count="{{$staff->count()}}" id="pagess">
                                        <li class="disabled"><a href="#"  id="prves" prevs="no">上一页</a></li>
                                        <li><a href="#" style="margin-left: 20px" nexts="1" id="nexts" >下一页</a></li>
                                        <li style="margin-left: 20px;">
                                            <select name="" id="jumpss">
                                            </select>
                                        </li>
                                        <li><a href="#" id="jumpsss">跳转</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"> <span class="glyphicon glyphicon-plus"> 入库详情</span>  </h4>
                        </div>
                        <!-- 主体 -->
                        <div class="modal-body">
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                ...
                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    ...
                    <tr class="gradeA odd {{$value->id}} select-remove">
                        ...
                        <td class="text-center">{{$value->Staff->name}}</td>
