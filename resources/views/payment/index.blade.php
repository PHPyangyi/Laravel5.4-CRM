                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title"> <span class="glyphicon glyphicon-plus"> 支出详情</span>  </h4>
                        </div>
                        <!-- 主体 -->
                        <div class="modal-body">
                            <table class="table table-hover table-bordered text-center">
                                <tr>
                                    <th colspan="5" align="left"> 支出详情</th>
                                </tr>
                                <tr>
                                    <td width="15%">产品名称：</td>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                ...
                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting_asc_disabled text-center"  >支出金额</th>
                    ...
                    <tr class="gradeA odd {$value.id} select-remove">
                        ...
                        <td class="text-center">
                         @if($value->mode =='采购')
                                ￥{{$value->Product->sell_price * $value->number}}
                         @else
                                ￥{{$value->Product->pro_price * $value->number}}
                         @endif
                        </td>
