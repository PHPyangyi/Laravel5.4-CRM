                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class=" control-label col-sm-2">分配给：</label>
                                    <div class="col-sm-10">
                                        <div class=" input-group">
                                            <input type="text" class="form-control "  id="staff_name"  readonly style="background-color: white"  >
                ...
                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                    ...
                    @foreach($work as $key => $value)
                        <tr class="gradeA odd {{$value->id}}  select-remove">
                            ...
                            <td class="text-center">{{$value->allo_name}}</td>
