            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"><?php echo e(\Auth::user()->name); ?> ( <?php echo e(\Auth::user()->Staff->name); ?> )</strong></span>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Index index')): ?>
                            <li>
                                <a class="J_menuItem" href="index" data-index="0"><i class="fa fa-home">首页</i></a>
                            </li>
                         <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Work index')): ?>
                            <li>
                                <a class="J_menuItem" href="work"><i class="fa fa-home">工作计划</i></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Allo index')): ?>
                            <li>
                                <a class="J_menuItem" href="allo"><i class="fa fa-home">分配任务</i></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inform index')): ?>
                            <li>
                                <a class="J_menuItem" href="inform"><i class="fa fa-home">通知管理</i></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Letter index')): ?>
                            <li>
                ...
                <?php endif; ?>
                <!--2-->
                <?php if(\Auth::user()->can('Client index')||
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Documentary index')): ?>
                        <li>
                ...
                <?php endif; ?>
                <!--3-->
                <?php if(\Auth::user()->can('Product index')||
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Inlib index')): ?>
                        <li>
                            <a class="J_menuItem" href="inlib" ><i class="fa fa-home">入库记录</i></a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Outlib index')): ?>
                        <li>
                            <a class="J_menuItem" href="outlib"><i class="fa fa-home">出库记录</i></a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Alarm index')): ?>
                        <li>
                            <a class="J_menuItem" href="alarm"><i class="fa fa-home">库存警报</i></a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Procure index')): ?>
                        <li>
                ...
                <?php endif; ?>
                <!--4-->
                <?php if(\Auth::user()->can('Receipt index')||\Auth::user()->can('Payment index')): ?>
                <li>
                    <a href="#">
                        <i class="fa fa-usd"></i>
                    ...
                    <ul class="nav nav-second-level">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Receipt index')): ?>
                        <li>
                ...
                <?php endif; ?>
                <!--5-->
                <?php if(\Auth::user()->can('User index') || \Auth::user()->can('Staff index')||\Auth::user()->can('Post index')): ?>
                <li>
                    <a href="#">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Staff index')): ?>
                        <li>
                            <a class="J_menuItem" href="staff"><i class="fa fa-home">员工档案</i></a>
                        </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Post index')): ?>
                        <li>
                ...
                <?php if(\Auth::user()->can('Permission index')||\Auth::user()->can('User_Role')||\Auth::user()->can('Role_Permission')): ?>
                <li>
                    <a href="#">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('User_Role')): ?>
                        <li>
