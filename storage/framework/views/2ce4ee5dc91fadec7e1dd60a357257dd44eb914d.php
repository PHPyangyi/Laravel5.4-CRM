                    ...
                    <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="gradeA odd {$value.id} select-remove">
                            ...
                            <td class="text-center ">
                                <?php $__currentLoopData = $value->permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo e($values->name); ?> ,
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </td>
                            <td class="text-center ">

                                <a  class="btn btn-info" href="/role_permission/distribution/<?php echo e($value->id); ?>">分配权限</a>
                                <a class="btn btn-warning" href="/role_permission/<?php echo e($value->id); ?>/edit">修改</a>
